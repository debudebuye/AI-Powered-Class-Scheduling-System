...
class RoomForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["r_number"].help_text = (
            "Leave blank to auto-generate (R001, R002, etc.)"
        )
...
class MeetingTimeForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "time": forms.Select(attrs={"class": "form-control-modern"}),
            "day": forms.Select(attrs={"class": "form-control-modern"}),
        }
        labels = {
            "pid": "Meeting Time ID",
            "time": "Time Slot",
...
class CourseForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "max_numb_students": forms.NumberInput(
                attrs={
                    "class": "form-control-modern",
            ...
            "instructors": forms.SelectMultiple(
                attrs={"class": "form-control-modern", "size": "4"}
            ),
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["course_number"].help_text = (
            "Leave blank to auto-generate (C001, C002, etc.)"
        )
...
class BatchForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "department": forms.Select(attrs={"class": "form-control-modern"}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["batch_id"].help_text = (
            "Leave blank to auto-generate (B001, B002, etc.)"
        )
...
class SectionForm(ModelForm):
    class Meta:
        ...
        widgets = {
            "section_id": forms.TextInput(
                attrs={
                    "class": "form-control-modern",
                    "placeholder": "Auto-generated (e.g., S001) - Leave blank for auto ID",
                }
            ),
            "batch": forms.Select(attrs={"class": "form-control-modern"}),
            "num_class_in_week": forms.NumberInput(
                attrs={
                    "class": "form-control-modern",
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["section_id"].help_text = (
            "Leave blank to auto-generate (S001, S002, etc.)"
        )
    ...
    def clean_file(self):
        ...
        if file:
            ...
            if ext not in self.ALLOWED_EXTENSIONS:
                raise forms.ValidationError(f"Only PDF files are allowed. Got: {ext}")
