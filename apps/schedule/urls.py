...
urlpatterns = [
    ...
    path('timings/<str:pk>/delete/', views.delete_meeting_time, name='deletemeetingtime'),
    ...
    path('departments/<int:pk>/delete/', views.delete_department, name='deletedepartment'),
